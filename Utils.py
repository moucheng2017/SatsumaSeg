...
# def segment_whole_volume(model, volume, train_size=[192, 192, 64]):
#     '''
#     volume: d x h x w
#     '''
...
def test(saved_information_path, saved_model_path, testdata, device, model_name, class_no, dilation=1):
