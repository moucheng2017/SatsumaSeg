...
parser.add_argument('--unlabelled', type=int, help='ratio between unlabelled and labelled data in one batch') # only used for SSL setting
...
parser.add_argument('--lung', type=bool, help='true when applying lung mask on the training data', default=False)
