...
def main():
    ...
    parser.add_argument('--log_tag', type=str, default='covid_hip_ct_1117', help='experiment tag for the record')
    ...
    parser.add_argument('--saving_starting', type=int, help='number of iterations when it starts to save', default=50)
    ...
    parser.add_argument('--gaussian', type=int, help='1 when add random gaussian noise', default=0)
