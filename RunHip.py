...
def main():
    ...
    parser.add_argument('--log_tag', type=str, default='covid_hip_ct_1102', help='experiment tag for the record')
    ...
    parser.add_argument('--saving_starting', type=int, help='number of iterations when it starts to save', default=200)
    parser.add_argument('--saving_frequency', type=int, help='number of interval of iterations when it starts to save', default=100)

    # hyper parameters for training (specific for semi sup)
    parser.add_argument('--unlabelled', type=int, help='SSL, ratio between unlabelled and labelled data in one batch, if set up as 0, it will be supervised learning', default=4)
    parser.add_argument('--detach', type=int, help='SSL, 1 when we cut the gradients in consistency regularisation or 0', default=0)
    parser.add_argument('--mu', type=float, help='SSL, prior Gaussian mean', default=0.7)  # mu
    parser.add_argument('--sigma', type=float, help='SSL, prior Gaussian std', default=0.1)  # sigma
    parser.add_argument('--alpha', type=float, help='SSL, weight on the unsupervised learning part', default=5.0)
