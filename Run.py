...
def main():
    ...
    parser.add_argument('--iterations', type=int, help='number of iterations', default=20000)
    ...
    parser.add_argument('--patience', type=int, help='patience for validate accurate', default=20000)
    ...
    parser.add_argument('--zoom', type=int, help='1 when use random zoom in augmentation', default=0)
